...
// What the feed actually renders. The Update Latest Articles workflow
// regenerates articles.json from the Medium RSS feed and opens a PR with the
// three posts picked during its pause; until that first PR merges the file
// ships with an empty list and the curated entries above stand in, so the
